...
var server = http.createServer(function (request, response){
    ...
    if(request.url === "/") {
     ...
     fs.readFile('views/cars/new.html', function (errors, contents){
...
else if (request.url === '/images/cat9.jpg') {
 fs.readFile('images/cat9.jpg', function (errors, contents){
     response.writeHead(200, {'Content-type': 'image/jpg'});
     response.write(contents);
     response.end();
 });
}
else if (request.url === '/images/cat10.jpg') {
 fs.readFile('images/cat10.jpg', function (errors, contents){
     response.writeHead(200, {'Content-type': 'image/jpg'});
     response.write(contents);
     response.end();
 });
    ...
    // request didn't match anything:
        ...
        response.end('File Not Found. Try Again.');
    }
});
